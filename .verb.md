...
_You might also be interested in [hyperscript][] or the [HAST](https://github.com/syntax-tree/hast) alternative [hastscript][]._  
_It may looks that `mich-h` is pretty similar - it's smaller and maybe not so perfect in some (edge) cases, but it's **enough** in most._
